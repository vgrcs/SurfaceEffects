...
VFILES:=Keys.v Tactics.v Nameless.v TypeLemmas.v Definitions.v Environment.v CorrectnessLemmas.v Heap.v TypeSystem.v EffectSystem.v Determinism.v Correctness.v 
